...
const contentImages = [
    {
        name: "berliner-prater.jpg",
        sourcePath: "/app/initial-data/images/berliner-prater.jpg",
        contentType: "image/jpeg",
        bucket: CONTENT_BUCKET_NAME,
    },
    {
        name: "create-story.jpg",
        sourcePath: "/app/initial-data/images/create-story.jpg",
        contentType: "image/jpeg",
        bucket: CONTENT_BUCKET_NAME,
    },
];
...
const storyImages = [
    {
        name: "story-1.jpg",
        sourcePath: "/app/initial-data/images/story-1.jpg",
        contentType: "image/jpeg",
        bucket: STORIES_BUCKET_NAME,
    },
    {
        name: "story-2a.jpg",
        sourcePath: "/app/initial-data/images/story-2a.jpg",
        contentType: "image/jpeg",
        bucket: STORIES_BUCKET_NAME,
    },
    {
        name: "story-2b.jpg",
        sourcePath: "/app/initial-data/images/story-2b.jpg",
        contentType: "image/jpeg",
        bucket: STORIES_BUCKET_NAME,
    },
    {
        name: "story-3.jpg",
        sourcePath: "/app/initial-data/images/story-3.jpg",
        contentType: "image/jpeg",
        bucket: STORIES_BUCKET_NAME,
    },
];
...
async function uploadImage(image) {
    try {
        ...
        if (error) {
            console.error(
                `Error uploading ${image.name} to ${image.bucket}:`,
                error,
            );
            return null;
        }
